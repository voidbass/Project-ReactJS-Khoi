...
export default class Banner extends Component {
	render() {
		return (
			<div className="container mw-100 p-0 d-none d-md-block" id="Product__Banner">
				<div className="p-0 container">
					<div className="row p-0">
						<div className="col-lg-4 col-md-4 p-0 topspace-50"><img className="gird-banner-ct1" src="/lib/imgs/text-banner.png" alt="text-banner.png" /></div>
